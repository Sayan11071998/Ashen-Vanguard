...
struct Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics
{
	struct _Script_AshenVanguard_eventOnAttackPerformedSignature_Parms
	{
		float Amount;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AshenVanguard_eventOnAttackPerformedSignature_Parms, Amount), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::NewProp_Amount,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AshenVanguard, nullptr, "OnAttackPerformedSignature__DelegateSignature", "CombatComponent", "OnAttackPerformedDelegate", Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::_Script_AshenVanguard_eventOnAttackPerformedSignature_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::_Script_AshenVanguard_eventOnAttackPerformedSignature_Parms) < MAX_uint16);
UFunction* Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature_Statics::FuncParams);
	}
...
void FOnAttackPerformedSignature_DelegateWrapper(const FMulticastScriptDelegate& OnAttackPerformedSignature, float Amount)
{
	...
	_Script_AshenVanguard_eventOnAttackPerformedSignature_Parms Parms;
	Parms.Amount=Amount;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_StaminaCost = { "StaminaCost", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombatComponent, StaminaCost), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StaminaCost_MetaData), NewProp_StaminaCost_MetaData) };
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_OnAttackPerformedDelegate = { "OnAttackPerformedDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::SparseMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombatComponent, OnAttackPerformedDelegate), Z_Construct_USparseDelegateFunction_AshenVanguard_OnAttackPerformedSignature__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnAttackPerformedDelegate_MetaData), NewProp_OnAttackPerformedDelegate_MetaData) }; // 4198778957
...
struct Z_CompiledInDeferFile_FID_Users_sayan_Projects_Ashen_Vanguard_AshenVanguard_Source_AshenVanguard_Public_Combat_CombatComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCombatComponent, UCombatComponent::StaticClass, TEXT("UCombatComponent"), &Z_Registration_Info_UClass_UCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatComponent), 3163193720U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_sayan_Projects_Ashen_Vanguard_AshenVanguard_Source_AshenVanguard_Public_Combat_CombatComponent_h_972325480(TEXT("/Script/AshenVanguard"),
